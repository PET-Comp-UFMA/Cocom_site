        ...
        <div class="container w-75 py-3">
            ...
            <div class="row mt-3 mb-3 bg-gray align-items-center">
                ...
                <div class="col-sm-9 py-3">
                    <p>Divulgando:</p>
                    <P><a href="documentos/FOLDER_SBPC.pdf">Segue em anexo um folder explicativo sobre a SBPC 2012</a>, para conhecimento e divulgação no referido programa de pós-graduação.</P>
                    <p>Coordenação SBPC UFMA</p>
                </div>
                <div class="col-sm-12 mt-2">
